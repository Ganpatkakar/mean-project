...
var TaskServices = (function () {
    ...
    TaskServices.prototype.getTasks = function () {
        return this.http.get('http://localhost:3001/api/tasks').map(function (res) { return res.json(); });
    };
    TaskServices.prototype.addTask = function (task) {
        var headers = new http_1.Headers();
        headers.append('Content-Type', 'application/json');
        return this.http.post('http://localhost:3001/api/task', JSON.stringify(task), { headers: headers })
            .map(function (res) { return res.json(); });
    };
    TaskServices.prototype.removeTask = function (removetaskId) {
        return this.http.delete('http://localhost:3001/api/task/' + removetaskId);
    };
    TaskServices.prototype.updateTask = function (task) {
        var headers = new http_1.Headers();
        headers.append('Content-Type', 'application/json');
        console.log(task);
    ...
    TaskServices.prototype.getCurrencyCountry = function (fromValues) {
        return this.http.get('http://api.fixer.io/latest?base=' + fromValues).map(function (res) { return res.json(); });
    };
    TaskServices.prototype.getAllProducts = function () {
